...
public class CRUD_DAO {
    ...
    private static final String CONNECTION_URL = "jdbc:sqlserver://TEMPEST:1433;databaseName=SOF2042_FINAL_TEST;user=sa;password=123456;trustServerCertificate=true";
