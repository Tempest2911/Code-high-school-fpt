...
public class DatabaseManager {
    ...
    public String[][] getTestques(int ID_Bai_Test) {
        ...
        try (Connection conn = getConnection(); PreparedStatement pstmt = conn.prepareStatement(sql, ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY)) {
    ...
    public static Object[][] getTestans(String[] cauTraloi, int ID_Bai_Test) {
        ...
        try (Connection conn = DriverManager.getConnection(URL); PreparedStatement pstmt = conn.prepareStatement(sql, ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY)) {
            pstmt.setInt(1, ID_Bai_Test);
            ResultSet rs = pstmt.executeQuery();
    ...
    public static float ChamDiem(String[] dapAnnguoiDung, int id_bai_test) {
        ...
        if (diem > 8.0) {
            try (Connection conn = DriverManager.getConnection(URL); PreparedStatement pstmt = conn.prepareStatement(sql2)) {
