...
public class ThongKeHVDAO {
    ...
    public static int getSoGioHoc(int idHocVien, int thang, int nam) {
    ...
    public static int getNhiemVuHoanThanh(int idHocVien, int thang, int nam) {
    ...
    public static int getNhiemVuChuaHoanThanh(int idHocVien, int thang, int nam) {
        String query = "SELECT COUNT(*) AS SoNhiemVu FROM Nhiem_Vu " +
    ...
    public static Map<String, Float> getDiemTrungBinh(int idHocVien, int thang, int nam) {
        ...
        String sql = "SELECT mh.Ten AS Mon_Hoc, COALESCE(AVG(bt.Diem), 0) AS Diem_Trung_Binh " +
                ...
                "AND YEAR(nv.Thoi_Gian_Bat_Dau) = ? " + // Sửa ở đây
                "GROUP BY mh.Ten " +
                "ORDER BY mh.Ten";
