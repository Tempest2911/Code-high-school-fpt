...
public class DemoTable extends javax.swing.JFrame {
    ...
    public void initTableData(){
        ...
        model.addRow(new Object[]{1, "Phong", 9.9});
        model.addRow(new Object[]{2, "Khoa", 5.6});
        model.addRow(new Object[]{3, "Quyet", 8.6});
    ...
    private void initComponents() {
        ...
        tblHocSinh.setFont(new java.awt.Font("sansserif", 0, 18)); // NOI18N
